...
public:
	...
	/**
	 * Returns the actors that are rendered in the current screen with a given tolerence.
	...
	static void GetSeenActors(APawn* Pawn, TArray<AActor*>& ResultActors, const float Tolerance = 0.01f);
};
